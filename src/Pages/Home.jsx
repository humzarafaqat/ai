        ...
        <div className="container pt-5">
            <div className="row g-5 pt-5">
                ...
                <div className="col-lg-6 align-self-end text-center text-lg-end">
                    <img className="img-fluid" src="img/hero-img.png" alt="Images" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div className="row g-5 align-items-center">
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div className="about-img">
                        <img className="img-fluid" src="img/about-img.jpg" alt="Images" />
                    </div>
                </div>
        ...
        <div className="container pt-5">
            <div className="row g-5">
                ...
                <div className="col-lg-6 align-self-end text-center text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <img className="img-fluid" src="img/feature.png" alt="Images" />
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div className="testimonial-item ps-5">
                            ...
                            <div className="d-flex align-items-center">
                                <img className="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-1.jpg"
                                    style={{ width: '60px' , height: '60px' }} alt="Images" />
                                <div className="ps-3">
        ...
        <div className="container">
            <div className="row g-5 align-items-center">
                <div className="col-md-5 ps-lg-0 pt-5 pt-md-0 text-start wow fadeIn" data-wow-delay="0.3s">
                    <img className="img-fluid" src="img/newsletter.png" alt="Images" />
                </div>
